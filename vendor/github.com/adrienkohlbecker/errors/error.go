...
func wrapInternal(e interface{}, skip int) *wrappedError {
...
func (err wrappedError) Stack() []byte {
	...
	for _, frame := range err.StackFrames() {
		...
		if err != nil {
			// err is always nil here, as per the documentation
			// make errcheck pass
		}
	}
